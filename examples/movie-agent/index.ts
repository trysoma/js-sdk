...
import {createServer} from '@trysoma/js-sdk'
import * as traceloop from "@traceloop/node-server-sdk";
import { OTLPTraceExporter } from '@opentelemetry/exporter-trace-otlp-grpc';
import { SimpleSpanProcessor } from '@opentelemetry/sdk-trace-node';
import { BatchLogRecordProcessor, LoggerProvider, SimpleLogRecordProcessor, LogRecordExporter } from '@opentelemetry/sdk-logs';
import {OTLPLogExporter} from '@opentelemetry/exporter-logs-otlp-grpc'
// import logsAPI from '@opentelemetry/api-logs'
// const OTEL_COLLECTOR_URL =  'http://localhost:4317'
// const headers = {
//   Authorization: 'Bearer auth_DYj0LDRXvdhgfLbHTUzDZo9AWhqOfXyg'
// }
...
// logger.emit({
//   body:       `[MovieAgentExecutor] Processing message ${userMessage.messageId} for task ${taskId} (context: ${contextId})`
...
const movieAgentCard: AgentCard = {
  ...
  url: 'http://localhost:8080/', // Example: if baseUrl in A2AExpressApp 
  provider: {
